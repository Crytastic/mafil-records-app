...
import { AppBar, mdTheme, Logo, Drawer, Sequence, Message } from '../components/Components';
...
export default function SuccessfulVisit() {
  ...
  return (
    <React.Fragment>
      ...
      >
        <Toolbar />
        <Message title='Visit aborted' text='Visit has been aborted by operator. It has been saved to the database and marked as aborted/unfinished.' />
      </Box>
    </React.Fragment >
  );
}
