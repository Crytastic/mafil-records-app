...
export default function Measuring() {
  ...
  return (
    <React.Fragment>
      <CommonAppBar stage={Stage.Measuring} open={open} toggleDrawer={toggleDrawer} handleRefresh={handleRefresh} />
      <CommonDrawer stage={Stage.Measuring} open={open} toggleDrawer={toggleDrawer} />
      <ListItems loading={loading} list={listSeries} errorMessage={fetchError} loadingMessage={`Fetching series`} />
    </React.Fragment>
  );
}
